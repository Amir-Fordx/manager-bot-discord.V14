...
module.exports = {
    ...
    .setName('updates')
    .setDescription('Update the bots precence.')
    ...
    .addSubcommand(subcommand => 
        ...
        .addStringOption(option => 
            option
            .setName('activity')
            .setDescription('Update the current activity.')
            .setRequired(true)
        )
    )
    .addSubcommand(subcommand => 
        ...
        .addStringOption(option =>
            ...
            .addChoices(
                ...
                { name: 'Do not distrub', value: 'dnd' },
                { name: 'Invisable', value: 'invisable' }
            )
        )
    ),
    ...
    async execute(interaction, client) {
        ...
        return interaction.reply({ embeds: [embed.setDescription(`<:succesfully:1080625167958560829> Succesfully update your ${sub} to **${type}**.`)]})
    }
}